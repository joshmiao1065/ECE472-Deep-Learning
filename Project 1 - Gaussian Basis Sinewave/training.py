...
def train_step(model: nnx.Module, optimizer: nnx.Optimizer, x: jnp.ndarray, y: jnp.ndarray) -> jnp.ndarray:
    """
...
def train(
    ...
    """
    log.info("Starting training", iters=settings.num_iters, batch_size=settings.batch_size, lr=settings.learning_rate)
